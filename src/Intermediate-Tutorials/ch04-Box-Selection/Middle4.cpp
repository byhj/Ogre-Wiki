...
bool Middle4::frameRenderingQueued(const Ogre::FrameEvent& fe)
{
...
bool Middle4::keyPressed(const OIS::KeyEvent& ke)
{
...
bool Middle4::keyReleased(const OIS::KeyEvent& ke)
{
...
bool Middle4::mouseMoved(const OIS::MouseEvent& me)
{
	CEGUI::GUIContext& context = CEGUI::System::getSingleton().getDefaultGUIContext();
...
bool Middle4::mousePressed(const OIS::MouseEvent& me, OIS::MouseButtonID id)
{
	CEGUI::GUIContext& context = CEGUI::System::getSingleton().getDefaultGUIContext();
...
bool Middle4::mouseReleased(const OIS::MouseEvent& me, OIS::MouseButtonID id)
{
	CEGUI::GUIContext& context = CEGUI::System::getSingleton().getDefaultGUIContext();
...
void Middle4::windowResized(Ogre::RenderWindow* rw)
{
...
void Middle4::windowClosed(Ogre::RenderWindow* rw)
{
	if (rw == mWindow)
	{
		if (mInputMgr)
...
void Middle4::chooseSceneManager()
{
	mSceneMgr = mRoot->createSceneManager(Ogre::ST_EXTERIOR_CLOSE);
}

void Middle4::createCamera()
{
...
void Middle4::destroyScene()
{
}

void Middle4::createFrameListener()
{
...
void Middle4::createResourceListener()
{
}

void Middle4::loadResources()
{
	Ogre::ResourceGroupManager::getSingleton().initialiseAllResourceGroups();
}

bool Middle4::setupCEGUI()
{
...
void Middle4::selectObject(Ogre::MovableObject* obj)
{
	obj->getParentSceneNode()->showBoundingBox(true);
	mSelected.push_back(obj);
}

void Middle4::swap(float& x, float& y)
{
	float temp = x;
	x = y;
	y = temp;
