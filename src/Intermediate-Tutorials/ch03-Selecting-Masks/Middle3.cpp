...
bool Middle3::frameRenderingQueued(const Ogre::FrameEvent& fe)
{
...
bool Middle3::keyPressed(const OIS::KeyEvent& ke)
{
...
bool Middle3::keyReleased(const OIS::KeyEvent& ke)
{
	// CEGUI::GUIContext& context = CEGUI::System::getSingleton().getDefaultGUIContext();
...
bool Middle3::mouseMoved(const OIS::MouseEvent& me)
{
	CEGUI::GUIContext& context = CEGUI::System::getSingleton().getDefaultGUIContext();
...
bool Middle3::mousePressed(const OIS::MouseEvent& me, OIS::MouseButtonID id)
{
	CEGUI::GUIContext& context = CEGUI::System::getSingleton().getDefaultGUIContext();
	...
	if (id == OIS::MB_Left)
	{
		...
		if (!mMovableFound)
		{
			Ogre::TerrainGroup::RayResult terrainResult =
				mTerrainGroup->rayIntersects(mouseRay);
...
bool Middle3::mouseReleased(const OIS::MouseEvent& me, OIS::MouseButtonID id)
{
	CEGUI::GUIContext& context = CEGUI::System::getSingleton().getDefaultGUIContext();
...
void Middle3::windowResized(Ogre::RenderWindow* rw)
{
...
void Middle3::windowClosed(Ogre::RenderWindow* rw)
{
	if (rw == mWindow)
	{
		if (mInputMgr)
...
void Middle3::chooseSceneManager()
{
	mSceneMgr = mRoot->createSceneManager(Ogre::ST_EXTERIOR_CLOSE);
}

void Middle3::createCamera()
{
...
void Middle3::destroyScene()
{
}

void Middle3::createFrameListener()
{
...
void Middle3::createResourceListener()
{
}

void Middle3::loadResources()
{
	Ogre::ResourceGroupManager::getSingleton().initialiseAllResourceGroups();
}

bool Middle3::setupCEGUI()
{
...
void Middle3::setupTerrain(Ogre::Light* light)
{
...
void Middle3::defineTerrain(long x, long y)
{
...
void Middle3::initBlendMaps(Ogre::Terrain* terrain)
{
...
void Middle3::configureTerrainDefaults(Ogre::Light* light)
{
...
void Middle3::handleCameraCollision()
{
