...
bool Middle2::frameRenderingQueued(const Ogre::FrameEvent& fe)
{
...
bool Middle2::keyPressed(const OIS::KeyEvent& ke)
{
...
bool Middle2::keyReleased(const OIS::KeyEvent& ke)
{
	// CEGUI::GUIContext& context = CEGUI::System::getSingleton().getDefaultGUIContext();
...
bool Middle2::mouseMoved(const OIS::MouseEvent& me)
{
	CEGUI::GUIContext& context = CEGUI::System::getSingleton().getDefaultGUIContext();
...
bool Middle2::mousePressed(const OIS::MouseEvent& me, OIS::MouseButtonID id)
{
	CEGUI::GUIContext& context = CEGUI::System::getSingleton().getDefaultGUIContext();
	...
	if (id == OIS::MB_Left)
	{
		...
		//changge the camera position to ray to test the insection
		Ogre::Ray mouseRay =
			mCamera->getCameraToViewportRay(
			mousePos.d_x / float(me.state.width),
			mousePos.d_y / float(me.state.height));
...
bool Middle2::mouseReleased(const OIS::MouseEvent& me, OIS::MouseButtonID id)
{
	CEGUI::GUIContext& context = CEGUI::System::getSingleton().getDefaultGUIContext();
...
void Middle2::windowResized(Ogre::RenderWindow* rw)
{
...
void Middle2::windowClosed(Ogre::RenderWindow* rw)
{
	if (rw == mWindow)
	{
		if (mInputMgr)
...
void Middle2::chooseSceneManager()
{
	mSceneMgr = mRoot->createSceneManager(Ogre::ST_EXTERIOR_CLOSE);
}

void Middle2::createCamera()
{
...
void Middle2::createScene()
{
	...
	CEGUI::Window* rootWin = wmgr.loadLayoutFromFile("Demo8.layout");

	CEGUI::System::getSingleton().getDefaultGUIContext().setRootWindow(rootWin);

}

void Middle2::destroyScene()
{
}

void Middle2::createFrameListener()
{
...
void Middle2::createResourceListener()
{
}

void Middle2::loadResources()
{
	Ogre::ResourceGroupManager::getSingleton().initialiseAllResourceGroups();
}

bool Middle2::setupCEGUI()
{
...
void Middle2::setupTerrain(Ogre::Light* light)
{
...
void Middle2::defineTerrain(long x, long y)
{
...
void Middle2::initBlendMaps(Ogre::Terrain* terrain)
{
...
void Middle2::configureTerrainDefaults(Ogre::Light* light)
{
...
void Middle2::handleCameraCollision()
{
