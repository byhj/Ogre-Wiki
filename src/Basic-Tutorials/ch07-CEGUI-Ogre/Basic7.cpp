...
void Basic7::createScene(void)
{
	...
	//this camera view is different with the origin camera
	...
	//Now we need to specify which image this StaticImage widget will display.
...
//inject ois key and mosue to cegui
