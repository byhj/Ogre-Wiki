...
bool CH4::processUnbufferedInput(const Ogre::FrameEvent &evt)
{
	...
	{
		Ogre::Light *light = mSceneMgr->getLight("PointLight");  //左鼠标按下，关闭点光源
...
bool CH4::frameRenderingQueued(const Ogre::FrameEvent &evt)
{
