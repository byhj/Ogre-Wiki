...
void CH7::createScene(void)
{
    ...
    CEGUI::Event::Subscriber(&CH7::quit, this));
...
void CH7::createFrameListener(void)
{
...
bool CH7::frameRenderingQueued(const Ogre::FrameEvent &evt)
{
	if (mWindow->isClosed())
		return false;
	if (mShutDown)
...
bool CH7::keyPressed(const OIS::KeyEvent &arg)
{
...
bool CH7::keyReleased(const OIS::KeyEvent &arg)
{
	CEGUI::System &sys = CEGUI::System::getSingleton();
    sys.injectKeyDown(arg.key);
    sys.injectChar(arg.text);
...
bool CH7::mouseMoved(const OIS::MouseEvent &arg)
{ 
...
bool CH7::mousePressed(const OIS::MouseEvent &arg, OIS::MouseButtonID id)
{
...
bool CH7::mouseReleased(const OIS::MouseEvent &arg, OIS::MouseButtonID id)
{
...
bool CH7::quit(const CEGUI::EventArgs &e)
{
    mShutDown = true;
    return true;
}