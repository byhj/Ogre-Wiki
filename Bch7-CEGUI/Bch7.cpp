...
void BCH7::createScene(void)
{
	...
	quit->subscribeEvent(CEGUI::PushButton::EventClicked,  CEGUI::Event::Subscriber(&BCH7::quit, this));
...
void BCH7::createFrameListener(void)
{
...
bool BCH7::frameRenderingQueued(const Ogre::FrameEvent &evt)
{
	if(mWindow->isClosed())
		return false;
...
bool BCH7::keyPressed(const OIS::KeyEvent &arg)
{
...
bool BCH7::keyReleased(const OIS::KeyEvent &arg)
{
...
bool BCH7::mousePressed(const OIS::MouseEvent &arg, OIS::MouseButtonID id)
{
...
bool BCH7::mouseReleased(const OIS::MouseEvent &arg, OIS::MouseButtonID id)
{
	CEGUI::System::getSingleton().getDefaultGUIContext().injectMouseButtonUp(convertButton(id));
	return true;
}

bool BCH7::mouseMoved(const OIS::MouseEvent &arg)
{ 
...
bool BCH7::quit(const CEGUI::EventArgs &e)
{
    mShutDown = true;
    return true;
}