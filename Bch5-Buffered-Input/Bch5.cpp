...
bool BCH5::frameRenderingQueued(const Ogre::FrameEvent& fe)
{
...
bool BCH5::keyPressed(const OIS::KeyEvent& ke)
{
	switch (ke.key)
	{
	case OIS::KC_ESCAPE:
...
bool BCH5::keyReleased(const OIS::KeyEvent& ke)
{
	switch (ke.key)
	{
	case OIS::KC_UP:
...
bool BCH5::mouseMoved(const OIS::MouseEvent& me)
{
