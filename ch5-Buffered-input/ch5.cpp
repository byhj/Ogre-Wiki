...
void CH5::createFrameListener(void)
{
...
bool CH5::frameRenderingQueued(const Ogre::FrameEvent &evt)
{
	if (mWindow->isClosed())
		return false;
	if (mShutDown)
...
// OIS::KeyListener
bool CH5::keyPressed( const OIS::KeyEvent& arg )
{
 switch (arg.key) {
				case OIS::KC_1:
...
bool CH5::keyReleased( const OIS::KeyEvent& arg )
{
			switch (arg.key)
			{
				case OIS::KC_UP:
...
// OIS::MouseListener
bool CH5::mouseMoved( const OIS::MouseEvent& arg )
{
...
bool CH5::mousePressed( const OIS::MouseEvent& arg, OIS::MouseButtonID id )
{		
...
bool CH5::mouseReleased( const OIS::MouseEvent& arg, OIS::MouseButtonID id )
{
	return true;
}
